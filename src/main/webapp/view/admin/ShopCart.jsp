...
<!--===============================================================================================-->
<link rel="stylesheet" type="text/css"
	href="view/fonts/linearicons-v1.0.0/icon-font.min.css">
<!--===============================================================================================-->
<link rel="stylesheet" type="text/css"
	href="view/vendor/animate/animate.css">
<!--===============================================================================================-->
<link rel="stylesheet" type="text/css"
...
<!--===============================================================================================-->
<link rel="stylesheet" type="text/css"
	href="view/vendor/perfect-scrollbar/perfect-scrollbar.css">
<!--===============================================================================================-->
	...
	<header class="header-v4">
			...
			<div class="wrap-menu-desktop how-shadow1">
				<nav class="limiter-menu-desktop container">
					...
					<a href="#" class="logo"> <img
						src="view/images/icons/logo-shoes.png" alt="IMG-LOGO">
					</a>
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li><a href="admin-product">Shop</a></li>

							<li class="label1" data-label1="hot"><a href="admin-shop-cart">Features</a>
							</li>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="home"><img src="view/images/icons/logo-shoes.png"
					alt="IMG-LOGO"></a>
			</div>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						...
						<div class="header-cart-item-txt p-t-8">
							<a href="#" class="header-cart-item-name m-b-18 hov-cl1 trans-04">
								<%=product.getName()%>
							</a> <span class="header-cart-item-info"> 1 x $<%=product.getCost()%>
							</span>
						</div>
					</li>
					<%
				...
				<div class="w-full">
					...
					<div class="header-cart-buttons flex-w w-full">
						<a href="shop-cart.html"
							...
							View Cart </a> <a href="shop-cart.html"
					...
					<div class="m-l-25 m-r--38 m-lr-0-xl">
						<div class="wrap-table-shopping-cart">
							<table class="table-shopping-cart">
								...
								<tr class="table_row">
									<td class="column-1">
										<div class="delete-product" data-product-id="<%=product.getId()%>">
									...
									<td class="column-3">$ <%=product.getCost() %></td>
									<td class="column-4">
											
											<center>1</center>

									</td>
									<td class="column-5">$ <%=product.getCost() %></td>
								</tr>
								<%
								}
								}
				...
				<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
					<div
						...
						<div class="flex-w flex-t bor12 p-b-13">
							...
							<div class="size-209">
								<span class="mtext-110 cl2"> $<%=sumCart %> </span>
							</div>
						</div>
		        ...
		        if (confirm("Are you sure you want to remove this item from your cart?")) {
		            ...
		            $.ajax({
		                ...
		                success: function(response) {
		                    // Reload or update the cart display
