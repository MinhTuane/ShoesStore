...
<%@ page import="shoesStore.model.HeaderImage" %>
<%@ page import="java.util.Base64" %>
<%@ page import="shoesStore.model.Product" %>

<%
	List<HeaderImage> headerImages =(List<HeaderImage>) request.getAttribute("headerImages");
	List<Product> tenPopularProducts =(List<Product>) request.getAttribute("tenPopularProducts");
	List<Product> tenRatingProducts =(List<Product>) request.getAttribute("tenRatingProducts");
%>
	...
	<header class="header-v2">
		...
		<div class="container-menu-desktop trans-03">
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop p-l-45">
					...
					<!-- Logo desktop -->		
					<a href="#" class="logo">
						<img src="view/images/icons/logo-shoes.png" alt="IMG-LOGO">
					</a>
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li>
								<a href="admin-product">Shop</a>
							</li>

							<li class="label1" data-label1="hot">
								<a href="admin-shop-cart">Features</a>
							</li>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="home"><img src="view/images/icons/logo-shoes.png" alt="IMG-LOGO"></a>
			</div>
		...
		<div class="menu-mobile">
			<ul class="main-menu-m">
				...
				<li>
					<a href="admin-shop-cart" class="label1 rs1" data-label1="hot">Features</a>
				</li>
		...
		<div class="sidebar flex-col-l p-t-22 p-b-25">
			...
			<div class="sidebar-content flex-w w-full p-lr-65 js-pscroll">
				<ul class="sidebar-link w-full">
					<li class="p-b-13">
						<a href="admin-home" class="stext-102 cl2 hov-cl1 trans-04">
							Home
						</a>
					</li>
				...
				<div class="sidebar-gallery w-full p-tb-30">
					...
					<div class="flex-w flex-sb p-t-36 gallery-lb">
						...
						<% if(headerImages != null) {
								for(HeaderImage headerImage : headerImages) {
									String image = Base64.getEncoder().encodeToString(headerImage.getImage());
						%>
						<div class="wrap-item-gallery m-b-10">
							<a class="item-gallery bg-img1" href="data:image/png;base64, <%=image%>" data-lightbox="gallery" 
							style="background-image: url('data:image/png;base64, <%=image%>');"></a>
						</div>
						<%}} %>
					</div>
				</div>
			...
			<div class="slick1">
				...
				<% if(headerImages != null) {
								for(HeaderImage headerImage : headerImages) {
									String image = Base64.getEncoder().encodeToString(headerImage.getImage());
				%>
				<div class="item-slick1" style="background-image: url('data:image/png;base64, <%=image%>');">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30">
							...
							<div class="layer-slick1 animated visible-false" data-appear="slideInUp" data-delay="1600">
								<a href="admin-product" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
									Shop Now
								</a>
							</div>
						</div>
		...
		<div class="flex-w flex-c-m">
			<div class="size-202 m-lr-auto respon4">
				...
				<div class="block1 wrap-pic-w">
					<img src="view/images/banner-04.jpg" alt="IMG-BANNER">
			...
			<div class="size-202 m-lr-auto respon4">
				<!-- Block1 -->
				<div class="block1 wrap-pic-w">
					<img src="view/images/banner-05.jpg" alt="IMG-BANNER">
				...
				<div class="tab-content p-t-50">
					...
					<div class="tab-pane fade show active" id="best-seller" role="tabpanel">
						...
						<div class="wrap-slick2">
							<div class="slick2">
								<%
									if(tenPopularProducts!=null) {
										for(Product product : tenPopularProducts) {
						...
						<div class="wrap-slick2">
							<div class="slick2">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="view/images/product-16.jpg" alt="IMG-PRODUCT">
						...
						<div class="wrap-slick2">
							<div class="slick2">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="view/images/product-15.jpg" alt="IMG-PRODUCT">
			...
			<div class="row">
					...
					<div class="blog-item">
						<div class="hov-img0">
							<a href="blog-detail.html">
								<img src="view/images/blog-01.jpg" alt="IMG-BLOG">
							</a>
						</div>
				...
				<div class="col-sm-6 col-md-4 p-b-40">
					<div class="blog-item">
						<div class="hov-img0">
							<a href="blog-detail.html">
								<img src="view/images/blog-02.jpg" alt="IMG-BLOG">
							</a>
						</div>
				...
				<div class="col-sm-6 col-md-4 p-b-40">
					<div class="blog-item">
						<div class="hov-img0">
							<a href="blog-detail.html">
								<img src="view/images/blog-03.jpg" alt="IMG-BLOG">
							</a>
						</div>
